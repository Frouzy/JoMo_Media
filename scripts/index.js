...
$(document).ready(function () {
    ...
    var text = ['We tell stories','We write them','We make it digital','With a vintage touch']
    var images = ['url(../images/slide1.jpg)','url(../images/work4.jpg)','url(../images/slide3.jpg)','url(../images/slide4.jpg)']
